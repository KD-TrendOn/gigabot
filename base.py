...
def _get_functions_single_prompt(
    ...
    *,
    ...
    prompt = create__prompt(system_message=system_message)
    return prompt
...
def create_pandas_dataframe_agent(
    ...
    df: Any,
    agent_type: Union[
        AgentType, Literal["openai-tools", "gigachat-functions"]
    ] = "gigachat-functions",
    ...
    **kwargs: Any,
    ...
    if agent_type == AgentType.ZERO_SHOT_REACT_DESCRIPTION:
        ...
        if agent_type == "gigachat-functions":
            agent = RunnableAgent(
                runnable=create_gigachat_functions_agent(llm, tools, prompt),  # type: ignore
                input_keys_arg=["input"],
                return_keys_arg=["output"],
            )
        else:
